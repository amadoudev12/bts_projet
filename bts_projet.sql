...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : sam. 15 nov. 2025 à 23:54
...
CREATE TABLE IF NOT EXISTS `etudiant` (
  `id_etudiant` varchar(15) COLLATE utf8mb4_general_ci NOT NULL,
  ...
  `sexe` varchar(15) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `filiere` (
  ...
  `nom_filiere` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `note` (
  ...
  `id_etudiant` varchar(15) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
INSERT INTO `utilisateur` (`id`, `nom_utilisateur`, `prenom_utilisateur`, `login`, `mot_passe`) VALUES
(1, 'Diallo', 'Amadou', 'Diallo45', 'Diallo19'),
(2, 'Ouattara', 'Mariame', 'mama', '12345'),
(3, 'Diallo', 'EL hadj Amadou', 'EL hadj Amadou Diallo', '11111');
